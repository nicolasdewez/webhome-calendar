...
class Initialization extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('CREATE SEQUENCE google_calendars_id_seq INCREMENT BY 1 MINVALUE 1 START 1;');
        ...
        $this->execute('ALTER TABLE google_calendars ADD CONSTRAINT FK_B16E0F97A40A2C8 FOREIGN KEY (calendar_id) REFERENCES calendars (id) NOT DEFERRABLE INITIALLY IMMEDIATE;');
    }
}
