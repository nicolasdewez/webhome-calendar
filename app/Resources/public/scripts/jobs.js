function JobsList (table)
{
    this.table = table;
    this.deactiveLinks = this.table.find('.appJobsList-actions .glyphicon-remove');
    this.activeLinks = this.table.find('.appJobsList-actions .glyphicon-ok');
    this.deleteLinks = this.table.find('.appJobsList-actions .glyphicon-trash');

    this.list = new List('.appJobsList-active', '.appJobsList-actions');
